...
<body>
    <div class="nav">
        <strong>演習切替:</strong>
        <a href="ex01.html" class="{active01}">01</a>
        <a href="ex02.html" class="{active02}">02</a>
        <a href="ex03.html" class="{active03}">03</a>
        <a href="ex04.html" class="{active04}">04</a>
        <a href="ex05.html" class="{active05}">05</a>
        <a href="ex06.html" class="{active06}">06</a>
        <a href="ex07.html" class="{active07}">07</a>
    </div>
...
for target_cat in categories:
    ...
    final_html = template.format(cat=target_cat, content=content_html, **active_flags)
    
    # ファイル書き出しパスを変更 (フォルダー名 + ファイル名)
